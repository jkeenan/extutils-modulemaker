...
#    if (1) {
    if (-f "/Users/jimk/Defaults.pm") {
        return ExtUtils::ModuleMaker::Regular->new(@_);
    } else {
        return ExtUtils::ModuleMaker::Special->new(@_);
    }
}
...
This document references version 0.36_16 of ExtUtils::ModuleMaker, released
